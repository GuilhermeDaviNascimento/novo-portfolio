...
export default function Home() {
  return (
    <div className="bg-[#f1f1f1] w-full h-full flex flex-col">
      <div className=" flex items-center px-48 justify-between w-full h-full">
        <div className="flex flex-col gap-2">
          ...
          <div className="flex gap-5">
            <div>
              <Button>View Projects <IoIosArrowForward /></Button>
            </div>
            <div>
        ...
        <div className="relative w-80 h-80">
          ...
          <div className="p-3 gap-5 absolute bottom-0 right-0 translate-y-1/2 bg-white rounded-xl justify-center items-center flex shadow-lg">
